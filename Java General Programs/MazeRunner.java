// Maze Runner - Final Project Assignment
...
public class MazeRunner {
    public static void main(String[] args){
        ...
        while (myMap.didIWin() == false) {
            ...
            if (myMap.isThereAPit(move)) {
                if (navigatePit().equals("y")) {
                    ...
                    myMap.printMap();
                    continue;                   //'continue' causes the loop to immediately jump to the next iteration of the loop without going over the rest of the lines in the loop.
                } else {
                    continue;
                }
            }
        ...
        if (myMap.didIWin() && count<100) {
            System.out.println("Congratulations, you win! You have made it out alive in " + count + " moves");
        }
    }
